<%@ page title="Requerimientos" language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="Requerimiento1, App_Web_js1z4v53" %>
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:DropDownList ID="cmbMoneda" runat="server" Visible="False">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
