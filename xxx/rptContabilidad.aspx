<%@ page language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="rptContabilidad, App_Web_js1z4v53" title="Reportes Contabilidad" %>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblFecha" runat="server" Font-Names="Arial" Font-Size="0.8em" ForeColor="DarkRed"
                                    Text="Fecha"></asp:Label></td>
                            <td>
                                <asp:TextBox ID="txtFecha" runat="server" Width="90px" MaxLength="12"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td>
