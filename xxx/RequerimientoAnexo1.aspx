<%@ page title="Requerimientos Via" language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="RequerimientoBolsa1, App_Web_3km2mpsz" %>
            ...
            <tr>
                ...
                <td align ="left">
                   <asp:Panel ID="panelContrato" runat="server" HorizontalAlign="Left">
                       <asp:CheckBox ID="chkAmpliacion" runat="server" Text="Ampliación Presupuestal" ForeColor="#990000" />&nbsp;
                       &nbsp;<asp:DropDownList ID="cmbContratoClase" runat="server">
                           <asp:ListItem Value="Obra">Obras</asp:ListItem>
                           <asp:ListItem Value="Otro">Bienes y Servicios</asp:ListItem>
                      ...
                      <div id="a2" style="width:700px;">
                      </div>
                      <div style="overflow:auto; height:200px; width:718px;">
                          <asp:GridView ID="grdvContrato" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="100%">
                              ...
                              <Columns>
                                  ...
                                  <asp:TemplateField HeaderText="Ok">
                                      <ItemTemplate>
                                          <asp:ImageButton ID="ImageButton3" runat="server" CommandName="itmDetalle" ImageUrl="~/Img/Elegir1.jpg" Width="19px" />
                                      </ItemTemplate>
