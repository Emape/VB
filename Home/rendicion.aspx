<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rendicion.aspx.vb" Inherits="Home_rendicion" %>
<style>
tr.highlighted td {
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
					...
					<select onchange="listar_combustible()" style='width:80px'name="anio" id="anio" aria-controls="tabla_inventario" class="form-control input-sm">
                        ...
                        <div class="dataTables_length">
                            ...
                            <i  class="fa fa-filter" ></i> &nbsp; Rendición
                        </span>
                            &nbsp;
...
<form id="rendicionInsert" class="form-horizontal" >	
...
<div class="modal fade" id="guiaiInsertModal" tabindex="-1" role="dialog" aria-labelledby="Login" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h1 class="modal-title" style="font-size:18px;font-weight:bold">Registrar Rendición</h1>
            ...
            <div class="modal-body">
                             ...
                             <div class="form-group">
                                <label class="col-lg-3 control-label">N° Ticket</label>
                                <div class="col-lg-5">
							...
							<div class="form-group">
                                <label class="col-lg-3 control-label">Fecha Rendición</label>
                                <div class="col-lg-5">
                            ...
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Precio Rendido</label>
                                <div class="col-lg-5">
							...
							<div class="form-group">
                                <label class="col-lg-3 control-label">Importe Rendido</label>
                                <div class="col-lg-5">
                                    <input type="text" class="form-control" name="importe" id="importe" readonly style="background:#ccc"/>
                                </div>
                            </div>
                  <br>
	         ...
	         <table id="tablasum"  class="table table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="tabla_inventario_info">
				  <thead>
                    <tr  class="cabecera">
                      ...
                      <th style="text-align:center" >Fecha Rendida </th>
    ...
    <script type="text/javascript">
        ...
        $('#cantidadg').keyup(function () {
            num1 = this.value * $("#precio").val()
            $("#importe").val(num1.toFixed(2));
        });

        $('#precio').keyup(function () {
            num2 = this.value * $("#cantidadg").val()
            $("#importe").val(num2.toFixed(2));
        });
        ...
        function listar_combustible() {
            ...
            $.ajax({
                ...
                url: 'http://isis:88/Services/Logistica/Transporte.svc/listarRendicion',
                dataType: "json",
                success: function (response) {
                    ...
                    $.each(customers, function () {
                        ...
                        + this.Idmc + " </td><td style='text-align:center'>" + this.Suministro + " </td><td style='text-align:left'> " + this.Chofer + "</td><td > " +
						this.Placa + "</td><td>" + this.FechaSum + "</td><td class='suministro'>" + this.Ticket + "</td><td>" + this.TipoCombustible + "</td><td style='text-align:right' class='cantidadsum'>" + this.CantidadRen + "</td><td style='text-align:right' class='preciosum'>" + this.PrecioRen + "</td><td style='text-align:right' class='importesum'>" + this.ImporteRen + "</td><td class='fechasum'>" + this.FechaRen + "</td><td class='IdTipoCombustible' style='display:none'>" + this.IdTipoCombustible + "</td> </tr>";
                        xnro++;
                    });
        ...
        $("#rendicionInsert").submit(function (event) {

            
            if ($("#osuministro").val() == "")
                alert("Ingrese el N° de Ticket");

            else if ($("#fechap").val() == "")
                alert("Ingrese la fecha de Rendición");
                ...
                var ary = $("#rendicionInsert").serializeArray();
                var obj = {};
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: 'http://isis:88/Services/Logistica/Transporte.svc/EditarRendicion',
