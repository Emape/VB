<%@ Page Language="VB" AutoEventWireup="false" CodeFile="~/Home/OrdenServicio.aspx.vb" Inherits="OrderCompra" %>
...
<section class="content">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header">
				    ...
				    <div class="row" id="Cabec_OrdenServicio">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-1"><input type="text" name="ActaConform" id="ActaConform" class="form-control"></div>
                    ...
                    <form id="AdicionarOrdendeCompra" class="form-horizontal" >     
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">--%>
                                        <h1 class="modal-title" style="font-size:18px;font-weight:bold"><label>Adicionar Orden de Servicio</label></h1>
                        
                                        <span style="float:right;margin-top:-28px">
                                            <span id="guardarordencompra" class="btn btn-primary" style="font-size:12px" onclick="carga_submit_guardarordencompra();SumarCostos() ">
                                                <i class="fa fa-save" ></i> &nbsp; GUARDAR
                                            </span>

                                            <span id="cancelarrordencompra" data-dismiss="modal" aria-label="Close" onclick="cerrar_InsertOrdenes()" class="btn btn-danger" style="font-size:12px" >
                                        ...
                                        <div class="row">
                                            <div class="col-xs-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-3" id="Tipo_CambioFech">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-1"><input  type="text" class="form-control" name="CertificacionOrden" id="CertificacionOrden"/></div>

                                                    <div class="col-lg-1"><input  type="text" class="form-control" name="TipoProveedor" id="TipoProveedor"/></div>
                                                    <div class="col-lg-1"><input  type="text" class="form-control" name="ExtTipoProv" id="ExtTipoProv"/></div>
                                                    ...
                                                    <div class="col-lg-4"><input  type="text" class="form-control" name="TipoDoc" id="TipoDoc"/></div>

                                                    <div class="col-lg-1"><input  type="text" class="form-control" name="TipoPrestacion" id="TipoPrestacion"/></div>

                                                    <div class="col-lg-4"><input  type="text" class="form-control" name="IdRequerimiento" id="IdRequerimiento"/></div>
                                                    <div class="col-lg-4"><input  type="text" class="form-control" name="AccionDC" id="AccionDC"/></div>
                                                </div>
                                                ...
                                                <%--<div class="row" style="margin-left:10px;margin-right:10px">
                                                    <div class="col-md-12" style="">--%>
                                                        <div class="box box-primary">
                                                            ...
                                                            <%--<div class="col-lg-2">
                                                                <input type="radio" id="consultor" name="consultor" > Consultor<br>
                                                            </div>

                                                            <div class="col-lg-2">
                                                                <input type="radio" id="asesor" name="asesor" > Asesor<br>
                                                            </div>

                                                            <div class="col-lg-2">
                                                                <input type="radio" id="locador" name="locador" > Locador<br>
                                                            </div>--%>

                                                            <%--<label class="col-lg-2 control-label">Proveedor</label>--%>

                                                            <label class="col-lg-2 control-label">Proveedor </label>
                                                            <div class="col-lg-6"><input type="text" placeholder="Digite 5 caract. de proveedor a buscar" name="search_prov" id="search_prov" class="form-control"></div>
                                                            ...
                                                            <%--<label class="col-lg-1 control-label">Buscar</label>--%>
                                                            <div class="col-lg-3"><input type="text" name="search_detreq" id="search_detreq" placeholder="Buscar" class="form-control"></div>
                  
                                                            <div class="box-body pad table-responsive" style="height:130px">
                                               ...
                                               <%--<div class="row" style="margin-left:10px;margin-right:10px">--%>
                                                    <div class="col-md-12" style="">
                                                        <div class="box box-primary">
                                                            ...
                                                            <div class="col-lg-2" id="rd_locador">
                                                                <input type="radio" id="locador" name="locador" > Locador<br>
                                                            </div>

                                                            <div class="col-lg-2" id="rd_servicios">
                                                                <input type="radio" id="servicios" name="servicios" > Servicio<br>
                                                            </div>

                                                            <div class="col-lg-2" id="rd_consultor">
                                                                <input type="radio" id="consultor" name="consultor" > Consultor<br>
                                                            </div>

                                                            <div class="col-lg-2" id="rd_asesor">
                                                                <input type="radio" id="asesor" name="asesor" > Asesor<br>
                                                            </div>
                                                            ...
                                                            <div class="box-body pad table-responsive" style="overflow:scroll;height:200px">
                                                                <table id="tabla_ocreq" class="table table-bordered table-hover dataTable no-footer">
				                                                    ...
				                                                    <tbody id="tbody_ocreq">
					                                                    <tr id="tbody_ocreq_sel"><td  colspan="18" align="center">No se encontraron resultados</td></tr>
				                                                    </tbody>
                                                                </table>
                                                            ...
                                                            <div class="col-lg-1"><input type="text" name="Nro_Filas" id="Nro_Filas" class="form-control"></div>
                                                            ...
                                                            <div class="col-lg-1"><input type="text" name="valor_ventaXCien" id="valor_ventaXCien" class="form-control"></div>

                                                            <div class="col-lg-1"><input type="text" name="FechaFinRNP" id="FechaFinRNP" class="form-control"></div>
                                                            <div class="col-lg-1"><input type="text" name="FechaActualxRNP" id="FechaActualxRNP" class="form-control"></div>
                                                            <div class="col-lg-1"><input type="text" name="FechaRNP" id="FechaRNP" class="form-control"></div>

                                                            <div class="col-lg-1"><input type="text" name="LocadorxRNP" id="LocadorxRNP" class="form-control"></div>
                        ...
                        <div class="row" id="ModifNewOrdenServicio">
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header">
                        ...
                        <%--<div class="modal fade" id="modificarOrden" role="dialog" aria-labelledby="Login" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">--%>
                                        <h1 class="modal-title" style="font-size:18px;font-weight:bold"><label>Modificar Orden de Servicio</label></h1>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-8">
                                                ...
                                                <label class="col-lg-2 control-label">Proveedor </label>
                                                <div class="col-lg-8"><input type="text" placeholder="Digite 5 caract. de proveedor a buscar" name="Proveedorm" id="Proveedorm" class="form-control"></div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">Anular Orden de Servicio</h4>
                                    </div>
            
                                    <div class="modal-body">
                                        <p>¿Desea Anular la Orden de Servicio N°  <span id="nro_orden"></span> ?</p>
                                        <p class="debug-url"></p>
                                    </div>
                        ...
                        <div class="modal fade" id="BuscarLocxOrd" role="dialog" aria-labelledby="Login" aria-hidden="true" >
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title" style="font-size:18px;font-weight:bold"><label>Busqueda de Ordenes de Servicio</label></h1>
                                    ...
                                    <div class="modal-body">
				                                ...
				                                <table id="T_CabBProveedores"  class="table table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="tabla_inventario_info">
				                                    <thead>
                                                        <tr  class="cabecera">
                                                            ...
                                                            <th style="text-align:center" ><b>Nro Acta </b></th>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="box box-primary">
                                                    <div class="box-header">
                                                        <h6 class="box-title"><small>Detalle de Orden de Servicio</small></h6>
                                                    </div>
                        ...
                        <div class="modal fade" id="BuscarProveedorxOrdenes" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title" id="H3">Proveedores que tienen Orden de Servicio</h4>
                        ...
                        <div class="modal fade" id="imprimirOrden" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title" id="H1">Imprimir Orden de Servicio</h4>
                                    </div>
                ...
                <div class="box-body pad table-responsive"   style="overflow:scroll;height:350px" id="Tabla_CabeceraOrdenServicio">
    ...
    <div class="row" id="Tabla_DetalleOrdenServicio">
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h6 class="box-title"><small>Detalle de Orden de Servicio</small></h6>
    ...
    <div class="row">
        <div class="col-xs-2">
		    <div class="dataTables_length">
			    <input type=text name="IdActaConformidad" id="IdActaConformidad" aria-controls="tabla_inventario" class="form-control input-sm">
			</div>
		</div>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#AdicionarOrdendeCompra").submit(function (event) {
            ...
            if ($("#VerifEnter").val() != "BuscarReq") {
                ...
                if ($("#PlazoEntrega").val() == "")
                    ...
                    alert("Ingrese un Concepto para la Orden de Servicio");
        ...
        $("#consultor").click(function () {
            $("#asesor").prop('checked', false);
            $("#locador").prop('checked', false);

            $("#TipoServicio").val("119");
        });

        $("#asesor").click(function () {
            $("#consultor").prop('checked', false);
            $("#locador").prop('checked', false);

            $("#TipoServicio").val("120");
        });

        $("#locador").click(function () {
            $("#consultor").prop('checked', false);
            $("#asesor").prop('checked', false);

            $("#TipoServicio").val("083");
        });
        ...
        $("#proveedorInsert").submit(function (event) {
            ...
            //else if ($("#ValCCI").val() == "ConCCI")
            //    if ($("#CCI").val() == "") 
            //        alert("Ingrese el CCI");
                
            //    else if ($("#ValBacTelewiese").val() == "S")
            //        alert("Seleccione Banco Telewise");
        ...
        $('.btn-anular').click(function (e) {
            ...
            $.ajax({
                ...
                data: '{"CodOrdenComp": "' + $("#id_orden").val() + '","CodRequer": "' + $("#id_requerimiento").val() + '","Usuario": "' + $("#IdUsuario").val() + '","CompraServicio": "S","Idanno": "' + $("#idanno").val() + '","CodCentroCostDet": "' + $("#CodCentroCostDet").val() + '","CodTransacDet": "' + $("#CodTransacDet").val() + '","Insertar": "E","IdAnno": "' + $("#idanno").val() + '","IdMes": "' + $("#idmes").val() + '","Dia": "' + $("#dia").val() + '","UsuarioDeta": "' + $("#IdUsuario").val() + '","empresa": "' + $("#id_empresa").val() + '" }',
                dataType: "json",
                success: function (response) {
        ...
        $('.btn-ok').click(function (e) {
            ...
            $.ajax({
                ...
                data: '{"IdOrdenCompraAnulada": "' + $("#IdOrdenCompraAnulada").val() + '","IdOrdenCompraActual": "' + $("#IdOrdenCompraActual").val() + '","CompraServicio": "S","empresa": "' + $("#id_empresa").val() + '" }',
                dataType: "json",
                success: function (response) {
    ...
    function ConfirmarGuardadoOrden() {
        confirmarAceptacion = confirm("Realmente desea guardar la Orden de Servicio");
    ...
    function GuardandoOrden() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                //    //datosReqOrdenes();
                //    //datosBienServOrdenes();
                //    //datosNumItemReqOrdenes()
                //}
                //else {
                //    alert("Error");
                //}
    ...
    //}
                ...
                function CentroCostoxOrden(IdReq) {
                    $.ajax({
                        ...
                        data: '{"IdRequerimiento": "' + IdReq + '","BienServicio": "S","empresa": "' + $("#id_empresa").val() + '"}',
                        dataType: "json",
                        success: function (response) {
                            var customers = eval(response.d);
                ...
                function CentroCostoxOrden() {
                    $.ajax({
                        ...
                        data: '{"BienServicio": "S","empresa": "' + $("#id_empresa").val() + '"}',
                        dataType: "json",
                        success: function (response) {
                            var customers = eval(response.d);
                            var html = "<option value='S' selected>Seleccione</option>";
                ...
                function listar_requerimiento() {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            $("#agregarcompraoservicio").val("S")
                            $("#agregarbienservicio").val("S")
                ...
                function listar_Brequerimiento() {
                    ...
                    $.ajax({
                        ...
                        data: '{"IdRequerimiento":"' + $("#search_ocreq").val() + '","BienServicio": "S","empresa":"' + $("#id_empresa").val() + '"}',
                        dataType: "json",
                        success: function (response) {
                            var customers = eval(response.d);
                            var html = "";
                ...
                //    alert("has hecho doble click en la tabla");
                //});
               ...
               // $('#agregarOrden').modal('show');
                    ...
                    function listar_orden() {
                        ...
                        $.ajax({
                            ...
                            data: '{"Idanno": "' + $("#Anno").val() + '","IdMes": "' + $("#Mes").val() + '","compraservicio": "S","empresa": "' + $("#id_empresa").val() + '"}',
                            dataType: "json",
                            success: function (response) {
                                var customers = eval(response.d);
                                var html = "";
                    ...
                    function Blistar_orden() {
                        ...
                        $.ajax({
                            ...
                            data: '{"BOrden": "' + $("#buscar_orden").val() + '","Idanno": "' + $("#Anno").val() + '","IdMes": "' + $("#Mes").val() + '","compraservicio": "S","empresa": "' + $("#id_empresa").val() + '"}',
                            dataType: "json",
                            success: function (response) {
                                var customers = eval(response.d);
                                var html = "";
                    ...
                    function detalle_orden(orden, requer, u) {
                        ...
                        $("#modificarcompraoservicio").val("S");
                    ...
                    function listar_ordenxProveedor(provord) {
                        ...
                        $.ajax({
                            ...
                            data: '{"Idanno": "' + $("#Anno").val() + '","compraservicio": "S","IdProveedor": "' + provord + '","empresa": "' + $("#id_empresa").val() + '"}',
                            dataType: "json",
                            success: function (response) {
                                var customers = eval(response.d);
                                var html = "";
                    ...
                    function listar_ordenxProveedor_Detalle(ordenprov) {
                        ...
                        $.ajax({
                            ...
                            data: '{"IdOrdenCompra": "' + ordenprov + '", "compraservicio": "S","empresa":"' + $("#id_empresa").val() + '"}',
                            dataType: "json",
                            success: function (response) {
                                var customers = eval(response.d);
                                var html = "";
                    ...
                    function datos_elimordencompra() {
                        $.ajax({
                            ...
                            data: '{"IdOrdenCompra": "' + $("#id_orden").val() + '","CompraServicio": "S","empresa": "' + $("#id_empresa").val() + '" }',
                            dataType: "json",
                            success: function (response) {
                                var customers = eval(response.d);
                                ...
                                $.each(customers, function () {
                                    ...
                                    $("#ActaConform").val(this.ActaConformidadOGuia)

                                    //EstadoBotones();                                   

                                    if ($("#Estado").val() == "A") {
                                        if ($("#ActaConform").val() == "SinActa      ") {
                                            $("#modificar").show();
                                            $("#eliminar").show();
                                            $("#imprimir").show();
                                        }
                                        else if ($("#ActaConform").val() != "SinActa      ") {
                                            $("#modificar").hide();
                                            $("#eliminar").hide();
                                            $("#imprimir").show();
                                        }
                    ...
                    function EstadoBotones() {
                        ...
                        var IdActaConformidad = $("#IdActaConformidad").val();

                        if (EstadoOrden == "A") {
                            OrdenesServicio_A();
                        }
                        else if (EstadoOrden == "D") {
                            OrdenesServicio_D();
                        }
                    }

                    function OrdenesServicio_A() {
                        if (IdActaConformidad == "") {
                            $("#modificar").show();
                            $("#eliminar").show();
                            $("#imprimir").show();
                        }
                        else if (IdActaConformidad != "") {
                            $("#modificar").hide();
                            $("#eliminar").hide();
                            $("#imprimir").show();
                        }
                    ...
                    function listar_orden_detalle(orden) {
                        ...
                        $.ajax({
                            ...
                            data: '{"IdOrdenCompra": "' + orden + '", "compraservicio": "S","empresa":"' + $("#id_empresa").val() + '"}',
                            dataType: "json",
                            success: function (response) {
                                var customers = eval(response.d);
                                var html = "";
                                ...
                                $.each(customers, function () {
                                    ...
                                    //html += "<tr id='fila" + xnro +
                                    //"'  onclick=detalle_orden('" + this.NumeroItemOrdenCompra + "','" + xnro + "') style='cursor:pointer'><td style='text-align:center'>"
                                    //+ xnro + " </td><td style='text-align:center'>"
                                    //+ this.NumeroItemOrdenCompra + " </td><td style='text-align:left'> " + this.IdRequerimiento + "</td><td > " +
                                    //this.IdCentroCosto + "</td><td>" + this.DesCentroCosto + "</td><td>" + this.Descripcion + "</td><td style='text-align:center' >" + this.ClasificadorGasto + "</td><td style='text-align:center' >" + this.IdProyecto + "</td><td style='text-align:center'>" + this.IdFinalidad + "</td><td style='text-align:center'>" + this.Meta + "</td><td style='text-align:center'>" + this.DescripcionUM + "</td><td style='text-align:center'>" + this.Cantidad + "</td><td style='text-align:center'>" + this.Costo + "</td><td style='text-align:center'>" + this.TotalCosto + "</td><td style='text-align:center'>" + this.DescripcionEstado + "</td> </tr>";
                                    //xnro++;
                    ...
                    function detalle_ordendet(u) {
                        ...
                        //listar_adicionar_orden_detalle();
                    }
                    ...
                    function cabecera_modif_ordencompra() {
                        ...
                        $.ajax({
                            ...
                            data: '{"IdOrdenCompra": "' + $("#id_orden").val() + '","IdRequerimiento": "' + $("#id_requerimiento").val() + '","CompraServicio": "S","empresa": "' + $("#id_empresa").val() + '" }',
                            //data: '{"fechaactual": "' + $("#fecha").val() + '" }',
                            dataType: "json",
                            success: function (response) {
                                var customers = eval(response.d);
                    ...
                    function Tipo_Proveedor() {
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: 'http://' + location.host + '/Services/Logistica/Almacen.svc/ExtraerTipoProv',
                            data: '{"RUC": "' + $("#TipoProveedor").val() + '","empresa": "' + $("#id_empresa").val() + '" }',
                            //data: '{"RUC": "10416889037","empresa": "' + $("#id_empresa").val() + '" }',
                            dataType: "json",
                            success: function (response) {
                                var customers = eval(response.d);
                                ...
                                $.each(customers, function () {
                                    ...
                                    $("#ExtTipoProv").val(this.Tipo_RUC)
                                    $("#Locador").val(this.Locador)
                    ...
                    function TipoDoc_xProveedor() {
                        if ($("#ExtTipoProv").val() == "20") {
                            $.ajax({
                                type: "POST",
                                contentType: "application/json; charset=utf-8",
                                url: 'http://' + location.host + '/Services/Logistica/Almacen.svc/listarTipoDoc',
                        ...
                        else if (($("#ExtTipoProv").val() == "10") || ($("#ExtTipoProv").val() == "15")) {
                            $.ajax({
                                type: "POST",
                                contentType: "application/json; charset=utf-8",
                                url: 'http://' + location.host + '/Services/Logistica/Almacen.svc/listarTipoDoc',
                            ...
                            $("#IdTipoDocumento").attr('disabled', false);
                        }
                        
                    }

                    function validacion_anulacionOS() {
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: 'http://' + location.host + '/Services/Logistica/Almacen.svc/validacionANUL_ordenservicio',
                            ...
                            success: function (response) {
                                ...
                                $.each(customers, function () {
                                    ...
                                    $("#IdActaConformidad").val(this.IdActaConformidad)
                    ...
                    function validacion_certifOrdenes(IdReq) {
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: 'http://' + location.host + '/Services/Logistica/Almacen.svc/validacionCentif_Ordenes',
                            data: '{"IdRequerimiento": "' + IdReq + '","IdAnno": "' + $("#Anno").val() + '","empresa": "' + $("#id_empresa").val() + '" }',
                            dataType: "json",
                            success: function (response) {
                                var customers = eval(response.d);
                                ...
                                $.each(customers, function () {
                                    ...
                                    if ($("#CertificacionOrden").val() == "NO EXISTE") {
                                        ...
                                        listar_adicionar_requerimiento_detalle(IdReq);
                                    }
                    ...
                    function DatosOrdenes() {
                        $.ajax({
                            ...
                            data: '{"CompraServicio": "S" ,"empresa": "' + $("#id_empresa").val() + '" }',
                            dataType: "json",
                            success: function (response) {
                                var customers = eval(response.d);
                    ...
                    function datosReqOrdenes() {
                        $.ajax({
                            ...
                            data: '{"IdOrdenCompra": "' + $("#id_orden").val() + '","CompraServicio": "S","IdAnno": "' + $("#idanno").val() + '","IdMes": "' + $("#idmes").val() + '","empresa": "' + $("#id_empresa").val() + '" }',
                            dataType: "json",
                            success: function (response) {
                                var customers = eval(response.d);
                    ...
                    function listar_modificar_requerimiento() {
                        ...
                        $.ajax({
                            ...
                            data: '{"IdOrdenCompra": "' + $("#id_orden").val() + '","CompraServicio": "S","BienServicio": "S","Idanno": "' + $("#Anno").val() + '","IdMes": "' + $("#Mes").val() + '","empresa": "' + $("#id_empresa").val() + '" }',
                            dataType: "json",
                            success: function (response) {
                                var customers = eval(response.d);
                                var html = "";
                        ...
                        $.ajax({
                            ...
                            data: '{"IdOrdenCompra": "' + $("#id_orden").val() + '","IdRequerimiento": "' + $("#id_requerimiento").val() + '","BienServicio": "S","CompraServicio": "S","empresa": "' + $("#id_empresa").val() + '" }',
                            dataType: "json",
                            success: function (response) {
                                var customers = eval(response.d);
                        ...
                        document.getElementById("tabla_req_modif").disabled = true;
                        document.getElementById("tabla_detreq_modif").disabled = true;
                        document.getElementById("tbody_ocreq_modif").disabled = true;
                    ...
                    function detalle_adicionarrequerimiento(adicorden, u) {
                        ...
                        validacion_certifOrdenes(IdReq);

                        extraer_descripReq(IdReq);
                        extraer_tipoprestacion(IdReq);
                    ...
                    function listar_adicionar_requerimiento_detalle(IdReq) {
                        ...
                        $.ajax({
                            ...
                            data: '{"IdRequerimiento": "' + IdReq + '","BienServicio": "S","IdTipoDocumento": "' + $("#IdTipoDocumento").val() + '","empresa": "' + $("#id_empresa").val() + '" }',
                            dataType: "json",
                            success: function (response) {
                                var customers = eval(response.d);
                                var html = "";
                                ...
                                $.each(customers, function () {
                                    $("#art_detalle").val(this.Detalle);
                                    $("#art_um").val(this.UM);
                                    html += "<tr style='cursor:pointer' class='asignar_ordcompreq'><td style='display:none'> <input type=text class=bool id='bool" + x + "' value='1' ><input type=text class=conta id='conta" + x + "' value='" + x + "' ></td><td style='display:none' class='idreq'>" + this.IdRequerimiento + "</td><td class='idnroitem'>" + this.IdNumeroItem + "</td><td class='idbienser'>" + this.IdBienServicio + "</td><td style='display:none' class='idum'>" + this.IdUnidadMedida + "</td><td class='descum'>" + this.UM + "</td><td class='descarti'>" + this.Descripcion + "</td><td class='ccosto'>" + this.Siglas + "</td><td style='display:none' class='clasif'>" + this.Clasificador + "</td><td style='display:none' class='act'>" + this.Actividad + "</td><td style='display:none' class='finali'>" + this.IdFinalidad + "</td><td style='display:none' class='met'>" + this.Meta + "</td><td class='cantid'>" + this.SaldoCantidad + "</td><td class='cstitem'>" + parseFloat(this.SaldoSubTotal / this.SaldoCantidad).toFixed(2) + "</td><td style='display:none' class='csitemope'>" + this.CostoItemOpe + "</td><td class='saldosbtot'>" + this.SaldoSubTotal + "</td><td style='display:none' class='montoreserv'>" + this.MontoAReservarActual + "</td><td style='display:none' class='saldoreserv'>" + this.SaldoReservaActual + "</td><td style='display:none' class='idcentcost'>" + this.IdCentroCosto + "</td><td style='display:none' class='partpres'>" + this.PartidaPresupuestal + "</td><td style='display:none' class='idtrans'>" + this.IdTransaccion + "</td><td style='display:none' class='idctacont'>" + this.IdCuentaContable + "</td><td style='display:none' class='idalmc'>" + this.IdAlmacen + "</td><td style='display:none' class='ttlinafecto'>" + this.Inafecto + "</td>    <td style='display:none' class='tasaimpto'>" + this.Tasa + "</td><td style='display:none' class='valope'>" + this.ValorOper + "</td><td style='display:none' class='ttlneto'>" + this.Neto + "</td></tr>";
                                    x++;
                                });
                                ...
                                //ActualizarSaldoRequerimiento(IdReq);
                    ...
                    function ActualizarSaldoRequerimiento(IdReq) {
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                    ...
                    function val_cant(u) {
                        ...
                        else if ((eval($('#cantidad' + u).val()) > "0")) {
                            $("#valcantidad").val("0");
                        }
                    }

                    function sol_subtot(u) {
                        //if (eval($('#montoreserva' + u).val()) < eval($('#costo' + u).val())) {
                        if ((eval($('#montoreserva' + u).val()) < eval($('#costo' + u).val())) || (eval($('#costo' + u).val()) == "0") || (eval($('#costo' + u).val()) == null)) {
                            $('#costo' + u).val($('#montoreserva' + u).val());
                        }
                    }
                    ...
                    function tasaimpuesto() {
                        $.ajax({
                            ...
                            data: '{"IdTipoDocumento": "' + $("#IdTipoDocumento").val() + '","empresa": "' + $("#id_empresa").val() + '" }',
                            dataType: "json",
                            success: function (response) {
                                var customers = eval(response.d);
                    ...
                    //funcion para matriz detalle orden servicio
                    ...
                    function modificar_ordencompra() {
                        $.ajax({
                            ...
                            success: function (response) {
                                $("#body_orden2").html('');
                                alert("Orden de Servicio modificada");
                                listar_orden();
                                limpiarOrden();
                                $("#cancelarmodifordencompra").click();
                                $("#modificar").hide();
                    ...
                    function limpiarOrden() {
                        ...
                        //$("#Proveedor option[value='P']").attr("selected", true);
                    ...
                    function ExtraerFechaFinRNP() {
                        $.ajax({
                            ...
                            data: '{"IdProveedor": "' + $("#proveedor").val() + '","CompraServicio": "S","empresa": "' + $("#id_empresa").val() + '" }',
                            dataType: "json",
                            success: function (response) {
                                var customers = eval(response.d);
                    ...
                    function cerrar_InsertOrdenes() {
                        ...
                        $("#Cabec_OrdenServicio").show();

                        $("#Tabla_CabeceraOrdenServicio").show();
                        $("#Tabla_DetalleOrdenServicio").show();

                    }

                    //Llenado Combo Tipo Documento
                    function TipoDocumentoxReq() {
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: 'http://' + location.host + '/Services/Logistica/Almacen.svc/listarTipoDoc',
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                $.each(customers, function () {
                                    ...
                                    var flag_TipoPrestacion = this.flagTipoPrestacion;
                                    
                                    $("#TipoPrestacion").val(this.flagTipoPrestacion);

                                    //ValidadTipoPrestacion();
                    ...
                    function extraer_tipoprestacion(IdReq) {
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: 'http://' + location.host + '/Services/Logistica/Almacen.svc/ExtraerDescripRequer',
                    ...
                    function ValidadTipoPrestacion() {

                        if ($("#TipoPrestacion").val() == " ") {
                            $("#locador").prop('checked', false);
                            $("#servicios").prop('checked', false);
                            $("#consultor").prop('checked', false);
                            $("#asesor").prop('checked', false);

                            $("#TipoServicio").val("002");

                            document.getElementById("IdTipoDocumento").disabled = false;

                            //ListarProveedorxReq();
                            if ($("#Proveedor").val() == "P" || $("#Proveedor").val() == null) {
                                ListarProveedorxReq();
                            }
                        }

                        if ($("#TipoPrestacion").val() == "L") {
                        ...
                        if ($("#TipoPrestacion").val() == "S") {
                            $("#servicios").prop('checked', true);
                            $("#TipoServicio").val("001");
                        ...
                        if ($("#TipoPrestacion").val() == "C") {
                            $("#consultor").prop('checked', true);
                            $("#TipoServicio").val("119");
                        ...
                        if ($("#TipoPrestacion").val() == "A") {
                            $("#asesor").prop('checked', true);
                            $("#TipoServicio").val("120");
                    ...
                    function ListarProveedorxReq() {
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: 'http://' + location.host + '/Services/Logistica/Almacen.svc/listarProveedoresxReq',
                            data: '{"TipoPrestacion": "' + $("#TipoPrestacion").val() + '","empresa": "' + $("#id_empresa").val() + '"}',
                            dataType: "json",
                            success: function (response) {
                                var customers = eval(response.d);
                                var html = "<option value='P' selected></option>";
                    ...
                    function Actualizar_Impuesto() {
                        $.ajax({
                            ...
                            data: '{"empresa": "' + $("#id_empresa").val() + '","CompraServicio": "S" }',
                            dataType: "json",
                            success: function (response) {
                    ...
                    function listar_TProveedoresxOrdenes() {
                        ...
                        $.ajax({
                            ...
                            data: '{"CompraServicio": "S","RazonSocial": "' + $("#buscar_orden").val() + '","empresa": "' + $("#id_empresa").val() + '"}',
                            dataType: "json",
                            success: function (response) {
                                var customers = eval(response.d);
                                var html = "";
                    ...
                    function detalle_proveedorM(prov, u) {
                        ...
                        $("#CerrarBuscarProv").click(); ValidarBusquedaProvM()
                            ...
                            success: function (response) {
                                ...
                                $.each(customers, function () {
                                    ...
                                    if (($("#NroFilas").val() == "0") && ($("#FlagEvaluado").val() == "A")) {
                                        alert("Requerimiento ya tiene Orden de Servicio");
                    ...
                    //function val_GuiasxOrdenes() {
                    //    $.ajax({
                    //        type: "POST",
                    //        contentType: "application/json; charset=utf-8",
                    //        url: 'http://' + location.host + '/Services/Logistica/Almacen.svc/validacionGuiaxOrden',
                    //        data: '{"IdOrdenCompra": "' + $("#id_orden").val() + '","IdRequerimiento": "' + $("#id_requerimiento").val() + '","IdAnno": "2016","empresa": "' + $("#id_empresa").val() + '" }',
                    //        dataType: "json",
                    //        success: function (response) {
                    //            var customers = eval(response.d);
                    ...
                    //                $("#ValGuiaxOrden").val(this.IdGuia)

                    //                var ValidadGuiasxOrdenes = $("#ValGuiaxOrden").val()

                    //                if (ValidadGuiasxOrdenes == "") {
                    //                    $("#modificar").show();
                    //                    $("#eliminar").show();
                    //                }
                    //                else {
